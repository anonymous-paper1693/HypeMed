...
class SparseActivatedMultiheadAttention(nn.Module):
    ...
    def __init__(self, embed_dim, num_heads, kdim=None, vdim=None, dropout=0., bias=True,
                 ...
                 encoder_decoder_attention=False, top_n=10):
        super().__init__()
...
if __name__ == '__main__':
    ...
    tgt = torch.randn(tgt_len, bsz, embedding_dim)
    src = torch.randn(src_len, bsz, embedding_dim)


    sp_mha = SparseActivatedMultiheadAttention(embedding_dim, n_heads, args, cur_attn_type='dc')
    output, attn = sp_mha(tgt, src, src)
    print(attn)